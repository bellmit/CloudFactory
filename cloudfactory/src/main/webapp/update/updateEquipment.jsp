            ...
            <div class="row" style="height: 500px">
                ...
                <div class="col-lg-6 bg-white">
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            <form method="get" action="${pageContext.request.contextPath}/user/updateHireEquipment">
                                <input type="hidden" name="equipmentID" value="${equipment.equipmentID}">
                                <div class="form-group">
                                    <span style="font-size: 15px;font-family: 黑体;">设备名称&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <input id="name" class="input-material" type="text" name="name" value="${equipment.name}" >
                                </div>

                                <div class="form-group">
                                    <span style="font-size: 15px;font-family: 黑体;">设备类型&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <select name="type" id="type" style="font-family: 黑体;font-size: 15px" value="${equipment.type}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="specifications" class="input-material" type="text" name="specifications" value="${equipment.name}" >
                                </div>
                                <div class="form-group">
                                    <span style="font-size: 15px;font-family: 黑体;">设备描述&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <input id="detail" class="input-material" type="text" name="detail" value="${equipment.detail}" >
                                </div>
                                ...
                                <div class="form-group">
<%--                                    <input type="hidden" name="updateId" value="${employee.empid}">--%>
                                    <input type="hidden" name="hireState" value="${equipment.hireState}">
