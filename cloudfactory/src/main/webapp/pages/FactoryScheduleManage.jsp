            ...
            <ul class="nav nav-pills nav-stacked side-navigation">
                ...
                <li class="menu-list nav-active"> <a href=""><i class="fa fa-drivers-license"></i> <span>投标管理</span></a>
                    <ul class="child-list">
                        ...
                        <li  class="active"><a href="FactoryScheduleManage.jsp">订单排产</a></li>
                ...
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/user/" method="post" >
                        <div class="form1 searchbox">
                            <ul class="row">
                                <li class="col-xs-3"> <span>排产ID：</span>
                    ...
                    <table class="table m-t-20">
                        ...
                        <tbody>
                        <c:forEach items="${factoryScheduleBidList}" var="bid">
                            <tr>
                                <td>${bid.bidID}</td>
                                <td>${bid.orderID}</td>
                                ...
                                <td>
                                    <div>
                                        <form hidden method="get" action="${pageContext.request.contextPath}/factory/scheduleManagePage" style="display: inline-block">
