            ...
            <ul class="nav nav-pills nav-stacked side-navigation">
                ...
                <li class="menu-list  nav-active"> <a href=""><i class="fa fa-drivers-license"></i> <span>投标管理</span></a>
                    <ul class="child-list">
                        ...
                        <li class="active"><a href="FactoryScheduleList.jsp">排产信息</a></li>
                    </ul>
                </li>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <table class="table m-t-20">
                        ...
                        <tbody>
                        <c:forEach items="${factoryScheduleList}" var="schedule">
                            <tr>
                                <td>${schedule.bidID}</td>
                                <td>${schedule.equipmentID}</td>
