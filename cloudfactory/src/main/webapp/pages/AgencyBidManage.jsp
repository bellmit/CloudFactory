    ...
    <div class="sidebar-left">
        <div class="sidebar-left-info">
            ...
            <ul class="nav nav-pills nav-stacked side-navigation">
                ...
                <li class="menu-list "><a href=""><i class="fa fa-users"></i> <span>订单管理</span></a>
                    <ul class="child-list">
                ...
                <li class="menu-list nav-active"> <a href=""><i class="fa fa-drivers-license"></i> <span>投标管理</span></a>
                    <ul class="child-list">
                        ...
                        <li class="active"><a href="AgencyBidManage.jsp">投标管理</a></li>
                    </ul>
                </li>
                ...
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/user/" method="post" >
                        ...
                        <div class="form1 searchbox">
                            <ul class="row">
                                <li class="col-xs-3"> <span>竞标ID：</span>
                    ...
                    <table class="table m-t-20">
                        ...
                        <tr>
                            ...
                            <th>工厂负责人</th>
                            <th>联系方式</th>
                            <th bgcolor="#00bfff">选标</th>
                        </tr>
                        </thead>

                        <tbody>
                        <%--                        到时候这里写一个if语句，如果没有信息的话就显示暂无--%>
                        <c:forEach items="${agencyBidList}" var="bid">
                            <tr>
                                <td>${bid.bidID}</td>
                                <td>${bid.orderID}</td>
                                ...
                                <td>
                                    <div>
                                        <form hidden method="get" action="${pageContext.request.contextPath}/agency/chooseBid" style="display: inline-block">
                                            <input type="hidden" value="${bid.bidID}" name="bidID">
