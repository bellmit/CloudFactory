    ...
    <div class="sidebar-left">
        <div class="sidebar-left-info">
            ...
            <ul class="nav nav-pills nav-stacked side-navigation">
                ...
                <li class="menu-list nav-active"> <a href=""><i class="fa fa-drivers-license"></i> <span>订单投标</span></a>
                    <ul class="child-list">
                        <li ><a href="FactoryOrderList.jsp">订单信息</a></li>
                        <li class="active" ><a href="FactoryOrderBid.jsp">订单投标</a></li>
                    </ul>
                </li>
                ...
                <div class="panel-body">
                    ...
                    <table class="table m-t-20">
                        ...
                        <tr>
                            ...
                            <th>联系方式</th>
                            <th>订单状态</th>
                            <th bgcolor="#00bfff">订单投标</th>

                        </tr>
                        </thead>

                        <tbody>
                        <c:forEach items="${bidOrderList}" var="order">
                            <tr>
                                <td>${order.orderID}</td>
                                ...
                                <td>
                                    <div>
                                        <form hidden method="get" action="${pageContext.request.contextPath}/factory/orderBidPage" style="display: inline-block">
                                            <input type="hidden" value="updateOrder" name="function">
