    ...
    <div class="sidebar-left">
        <div class="sidebar-left-info">
            ...
            <ul class="nav nav-pills nav-stacked side-navigation">
                ...
                <li class="menu-list" nav-active><a href=""><i class="fa fa-shopping-cart"></i> <span>投标管理</span></a>
                    <ul class="child-list">
                        <li class="active"><a href="bidList.jsp">投标信息</a></li>
                    </ul>
                </li>
